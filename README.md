...
<a name="preprocessing"> <a/>
 ...
 공원 및 녹지 | 공원 수, 1인당 공원면적
 교육환경 | 도서관 수 (대표,국립,공공,작은,장애인,전문 도서관 6가지 도서관 종류 중 대표(중구), 국립(강남,서초,영등포구), 공공도서관(그 외)의 수만 집계)
 청결도 | 대기오염, 수질오염, 길거리의 쓰레기방치
...
각 주제 변수들 간의 상관관계를 보면 `공원면적-문화시설`, `의료기관-치안방범`, `문화시설-대중교통`, `상업시설-주차시설`, `보행안전-주차시설`, `대중교통-주차시설` 관계에서 **강한 양적 선형관계(0.7~1.0)** 를 보여주고 있다. 또한, 부정적인 영향도인 `청결도`와 `소음민원`에서 다른 변수들과 음의 상관관계를 많이 보인다는 것을 볼 수 있고, 특히 `청결도` 항목에서 `문화시설`, `상업시설`, `보행안전`, `주차시설`, `대중교통`의 항목들과 **강한 음적 선형관계(-1.0~-0.7)** 를 보여주고 있다.
